...
def test_deepinfra_config():
    ...
    try:
        ...
        assert crawled_dims == 1024, f"crawled_pages: esperado 1024, obtido {crawled_dims}"
        ...
        assert dims_override == 512, f"Override falhou: esperado 512, obtido {dims_override}"
