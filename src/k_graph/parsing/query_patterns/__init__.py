...
from . import python_queries
from . import javascript_queries
from . import typescript_queries
from . import java_queries
from . import go_queries
from . import c_queries
