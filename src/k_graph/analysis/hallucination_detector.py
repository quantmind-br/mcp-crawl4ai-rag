...
Examples:
  ...
  python hallucination_detector.py script.py
  
  # Analyze multiple scripts
  python hallucination_detector.py script1.py script2.py script3.py
  
  # Specify output directory
  python hallucination_detector.py script.py --output-dir reports/
  
  # Skip markdown report
  python hallucination_detector.py script.py --no-markdown
        """,
    )
