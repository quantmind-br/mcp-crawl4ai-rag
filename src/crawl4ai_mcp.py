...
print("🔧 Debug: Initializing FastMCP server...")
try:
    mcp = FastMCP(
        "mcp-crawl4ai-rag",
    ...
    print("✅ Debug: FastMCP server initialized successfully")
except Exception as e:
    print(f"❌ Debug: Error initializing FastMCP: {e}")
    raise
...
def main():
    ...
    print(f"🔍 Debug: TRANSPORT={transport}, HOST={host}, PORT={port}")
    ...
    if transport == 'sse':
        ...
        print(f"📡 Connect your MCP client to: http://{host}:{port}/sse")
        try:
        ...
        print(f"📡 Connect your MCP client to: http://{host}:{port}/mcp")
        try:
