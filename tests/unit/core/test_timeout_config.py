...
class TestTimeoutConfiguration:
    ...
    def test_default_timeout_values(self):
        ...
        with patch.dict(os.environ, {}, clear=False):
            ...
            for key in ['MCP_QUICK_TIMEOUT', 'MCP_MEDIUM_TIMEOUT', 'MCP_LONG_TIMEOUT', 'MCP_VERY_LONG_TIMEOUT']:
    ...
    def test_constants_exist_in_module(self):
        ...
        for constant in required_constants:
            assert hasattr(app_module, constant), f"Constant {constant} not found in app module"
