...
class TestGrammarInitialization:
    ...
    def test_check_grammars_directory_missing(self):
        ...
        with mock.patch(
            "src.utils.grammar_initialization.get_grammars_directory"
        ) as mock_get_dir:
            mock_path = mock.Mock()
    ...
    def test_initialize_grammars_already_available(self):
        ...
        with mock.patch(
            "src.utils.grammar_initialization.check_essential_grammars"
        ) as mock_check:
    ...
    def test_initialize_grammars_need_building(self):
        ...
        with (
            ...
            mock.patch(
                "src.utils.grammar_initialization.check_grammars_directory"
            ) as mock_check_dir,
            mock.patch(
                "src.utils.grammar_initialization.run_grammar_builder"
            ) as mock_run_builder,
